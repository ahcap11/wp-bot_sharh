...
export class AIService {
  ...
  async interpretSalesMessage(
    ...
    const system = [
      ...
      'Never relabel USD, EUR, GBP, SAR, or another non-AED currency as AED and never silently convert currencies. If a buyer gives only a non-AED budget, leave buyer_budget_aed empty and ask for the maximum in AED.',
