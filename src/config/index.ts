...
const envSchema = Joi.object({
  ...
  SHARH_API_PUBLIC_LISTING_FIELDS: Joi.string().default(
    'id,public_code,title,subtitle,sector,region,emirate,description,price,asking,price_int,revenue,ebitda,monthly_net_profit,tags,ribbon,sale_type,match_score,ranking_score,match_strength,listing_quality_score,financial_warnings,match_reasons,match_gaps,hard_gap_labels,relaxation_distance,annual_profit_aed,profit_basis,roi_pct,passive_evidence,passive_evidence_label,parsed_price_aed'
  ),
